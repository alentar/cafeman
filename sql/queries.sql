...
INNER JOIN TABLES ON TABLES
    .Id = customer_reservations.Id
WHERE
...
WHERE
    customers.Mobile = '0712345678' AND (
        customer_reservations.StartTime >= '2020-06-01' AND customer_reservations.EndTime <= '2020-06-15'
    )
...
FROM
    ...
    customers
WHERE
    customers.Mobile = '0712345678' AND customers.Id = orders.CustomerId AND orders.CreatedAt BETWEEN '2020-06-01' AND '2020-06-20'
