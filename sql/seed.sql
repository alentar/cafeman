...
VALUES
    (NULL, 'Chathurangi', 'Silva', '0712345678'),
...
VALUES
    (NULL, 'Sandwitch', '1299', 'breakfast meal'),
    (
        NULL,
        'Rice with Sambol',
        '500',
        'rice with pol sambol'
    ),
    (NULL, 'Bread', '300', 'Bread with curry'),
    (
        NULL,
        'String Hoppers',
        '450',
...
VALUES
    ('1', '1', NULL, NULL),
    ('2', '2', NULL, NULL),
    ('3', '3', '2020-06-09 19:24:33', NULL),
    ('4', '1', '2020-06-10 19:24:42', NULL),
    (
        '5',
        '1',
        '2020-06-09 19:24:56',
